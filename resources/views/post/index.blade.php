...
<div class="bg-gray-100 min-h-screen py-10 px-4 lg:px-20">
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white shadow-lg rounded-lg mb-10 overflow-hidden">
            ...
            <!-- Botón de eliminar publicación (solo si el usuario es el propietario del post) -->
            @if ($post->user_id === Auth::id())
            <div class="p-4 border-t border-gray-200">
                <form action="{{ route('posts.delete', $post->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este post?');">
                    @csrf
                    @method('DELETE')
